...
{
    std::string genesisblockhash = "0000026ad6b1794c268f5353486d646ff8a6b1af5beaec5f2741a9614ff380a1";
...
void BlockExplorer::showEvent(QShowEvent*)
{
    if (m_NeverShown) {
        ...
        if (!GetBoolArg("-txindex", true)) {
            QString Warning = tr("Not all transactions will be shown. To view all transactions you need to set txindex=1 in the configuration file (ultradash.conf).");
            QMessageBox::warning(this, "Ultradash Coin Blockchain Explorer", Warning, QMessageBox::Ok);
        }
    }
}
...
{
    QString CSS = "body {font-size:12px; color:#f8f6f6; bgcolor:#0173ab;}\n a, span { font-family: monospace; }\n span.addr {color:#0173ab; font-weight: bold;}\n table tr td {padding: 3px; border: 1px solid black; background-color: #0173ab;}\n td.d0 {font-weight: bold; color:#f8f6f6;}\n h2, h3 { white-space:nowrap; color:#0173ab;}\n a { color:#88f6f6; text-decoration:none; }\n a.nav {color:#0173ab;}\n";
