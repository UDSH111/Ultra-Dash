...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("Ultradash Coin"),
     ...
     * override -datadir in the ultradash.conf file in the default data directory
     * (to be consistent with ultradashd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
