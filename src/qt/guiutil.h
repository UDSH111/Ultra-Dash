...
/** Utility functions used by the Ultradash Qt UI.
 */
namespace GUIUtil
{
...
// Render Ultradash addresses in monospace font
...
// Parse "ultradash:" URI into recipient object, return true on successful parsing
