...
static void NotifyzUDSHReset(WalletModel* walletmodel)
{
    qDebug() << "NotifyzUDSHReset";
...
void WalletModel::subscribeToCoreSignals()
{
    ...
    wallet->NotifyzUDSHReset.connect(boost::bind(NotifyzUDSHReset, this));
...
void WalletModel::unsubscribeFromCoreSignals()
{
    ...
    wallet->NotifyzUDSHReset.disconnect(boost::bind(NotifyzUDSHReset, this));
...
{
    setMints.clear();
    setMints = pwalletMain->zudshTracker->ListMints(fUnusedOnly, fMaturedOnly, fUpdateStatus, fWrongSeed);
}
