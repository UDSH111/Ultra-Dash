...
public:
    ...
    void setZUdshControlLabels(int64_t nAmount, int nQuantity);
...
// MINT disabled    void on_pushButtonMintzUDSH_clicked();
    void on_pushButtonMintReset_clicked();
    void on_pushButtonSpentReset_clicked();
    void on_pushButtonSpendzUDSH_clicked();
    void on_pushButtonZUdshControl_clicked();
