                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzUDSHPathCustom = GetArg("-zudshbackuppath", "");
    ...
    if(!strzUDSHPathCustom.empty()) {
        ui->wallet_customzudshbackuppath->setText(QString::fromStdString(strzUDSHPathCustom));
        ui->wallet_customzudshbackuppath_label->setVisible(true);
        ui->wallet_customzudshbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzUDSHPathCustom.empty()) && nCustomBackupThreshold > 0) {
