...
/* Ultradash GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Ultradash"
#define QAPP_ORG_DOMAIN "ultradash.org"
#define QAPP_APP_NAME_DEFAULT "Ultradash-Qt"
#define QAPP_APP_NAME_TESTNET "Ultradash-Qt-testnet"
