...
SplashScreen::SplashScreen(Qt::WindowFlags f, const NetworkStyle* networkStyle) : QWidget(0, f), curAlignment(0)
{
    ...
    QString titleText = tr("Ultradash Coin");
	...
	QString copyrightTextUltradash = QChar(0xA9) + QString(" %1 ").arg(COPYRIGHT_YEAR) + QString(tr("The Ultradash developers"));
    ...
    pixPaint.setPen(QColor(1, 115, 171));
	...
	pixPaint.drawText(paddingLeft, paddingTop + titleCopyrightVSpace + 36, copyrightTextUltradash);
