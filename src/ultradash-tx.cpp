...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Ultradash Coin ultradash-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  ultradash-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded ultradash transaction") + "\n" +
                               "  ultradash-tx [options] -create [commands]   " + _("Create hex-encoded ultradash transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded ultradash transaction
