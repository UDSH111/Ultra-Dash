...
#include "key.h"
#include "zudsh/accumulatorcheckpoints.h"
...
BOOST_AUTO_TEST_CASE(deterministic_tests)
{
    ...
    CzUDSHWallet zWallet(wallet.strWalletFile);
    ...
    for (int i = 0; i < nTests; i++) {
        ...
        zWallet.GenerateDeterministicZUDSH(denom, coin, dMint);
