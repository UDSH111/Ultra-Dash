...
#ifndef Ultradash_ZUDSHTRACKER_H
#define Ultradash_ZUDSHTRACKER_H
...
public:
    CzUDSHTracker(std::string strWalletFile);
    ~CzUDSHTracker();
    void Add(const CDeterministicMint& dMint, bool isNew = false, bool isArchived = false, CzUDSHWallet* zUDSHWallet = NULL);
...
#endif //Ultradash_ZUDSHTRACKER_H
