...
#ifndef Ultradash_ZUDSHWALLET_H
#define Ultradash_ZUDSHWALLET_H
...
public:
    CzUDSHWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZUDSH(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZUDSH(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);
