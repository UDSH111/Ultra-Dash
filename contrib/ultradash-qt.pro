...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/ultradash-cli.cpp \
           src/ultradash-tx.cpp \
           src/ultradash.cpp \
           src/db.cpp \
...
RESOURCES += src/qt/ultradash.qrc src/qt/ultradash_locale.qrc

TRANSLATIONS += src/qt/locale/ultradash_bg.ts \
                src/qt/locale/ultradash_de.ts \
                src/qt/locale/ultradash_en.ts \
                src/qt/locale/ultradash_es.ts \
                src/qt/locale/ultradash_fi.ts \
                src/qt/locale/ultradash_fr.ts \
                src/qt/locale/ultradash_it.ts \
                src/qt/locale/ultradash_ja.ts \
                src/qt/locale/ultradash_pl.ts \
                src/qt/locale/ultradash_pt.ts \
                src/qt/locale/ultradash_ru.ts \
                src/qt/locale/ultradash_sk.ts \
                src/qt/locale/ultradash_sv.ts \
                src/qt/locale/ultradash_vi.ts \
                src/qt/locale/ultradash_zh_CN.ts \
                src/qt/locale/ultradash_zh_TW.ts
