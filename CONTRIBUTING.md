Contributing to Ultradash Coin
============================

The Ultradash Coin project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/ultradash-project/ultradash/blob/master/doc/translation_process.md)
...
The following applies to code changes to the Ultradash Coin project, and is not to be
confused with overall Ultradash Network Protocol consensus changes.

Whether a pull request is merged into Ultradash Coin rests with the project merge
...
Patches that change Ultradash consensus rules are considerably more involved than
...
Where a patchset proposes to change the Ultradash consensus, it must have been
...
The project leader is the release manager for each Ultradash Coin release.
