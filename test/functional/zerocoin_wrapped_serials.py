...
from fake_stake.base_test import Ultradash_FakeStakeTest

class zUDSHwrappedSerialsTest(Ultradash_FakeStakeTest):
    ...
    def run_test(self):
        ...
        # 2) Mint zerocoins
        self.log.info("Minting %d-denom zUDSHs..." % DENOM_TO_USE)
